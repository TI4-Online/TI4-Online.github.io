...
class Calc {
  ...
  process(gameData) {
    ...
    for (let regionIndex = 0; regionIndex < 4; regionIndex++) {
      ...
      result.push({
        name: regionName,
        attackerColor: activePlayerColorName,
        defenderColor: peerColorName ? peerColorName : "",
...
function ti4calcWrapper(gameData) {
  return Calc.getInstance().process(gameData);
}
window.ti4calcWrapper = ti4calcWrapper;
